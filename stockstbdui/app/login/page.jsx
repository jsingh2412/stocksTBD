  ...
  return (
    <div className='w-full flex flex-col items-center'>
        ...
        <div className="flex gap-7 m-auto">
            <div className="flex justify-center items-center w-56 h-16 text-primary-green text-2xl bg-white cursor-pointer rounded-3xl font-koho font-bold">Login</div>
        </div>
        </div>
        <span className='text-2xl font-koho font-semibold text-primary-green text-center mt-2'>or</span>
        <GoogleSignInButton />
    </div>
